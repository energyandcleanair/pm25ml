...
square_size = 10000  # polygon size
...
def main():
    ...
    grid_india_10km = gpd.GeoDataFrame(geom_array, columns=['geometry']).set_crs('EPSG:7755')
    grid_india_10km['grid_id'] = list(grid_india_10km.index)

    return grid_india_10km